import LocationDaerahTable from "./Table"

const LocationDaerah = () => {
  return (
    <div className='font-regular'>
      <div className='p-5 bg-white'>
        <h1 className='text-lg font-semibold text-gray-500'>Lokasi Daerah</h1>
      </div>
      <div className='p-8 h-35 items-center'>
        <div className="flex h-full bg-white rounded-xl gap-4">
          ...
          <div className='my-auto'>
            <h2 className="text-3xl font-bold">Lokasi Daerah</h2>
